...
# The preparation of recipes takes some time. Find the shortest and longest cooking times. In the result table,
# display the shortest cooking time (name column as min_time), and the longest cooking time (name column as max_time).
...
# A lot of people don't have much time to cook. Get the recipes which have cooking times below average for all
# recipes in the recipe table. Return the names and cooking times for those recipes.
